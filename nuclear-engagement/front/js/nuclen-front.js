window.NuclenLazyLoadComponent=function(z,d=null){const i=document.getElementById(z);if(!i)return;const u=new IntersectionObserver(g=>{g.forEach(p=>{p.isIntersecting&&(d&&typeof window[d]=="function"&&window[d](),u.disconnect())})},{rootMargin:"0px 0px -200px 0px",threshold:.1});u.observe(i)};function L(z,d){const i=document.querySelector(z);if(!i)return;new IntersectionObserver((g,p)=>{g.forEach(l=>{l.isIntersecting&&l.intersectionRatio===1&&(typeof gtag=="function"&&gtag("event",d),p.unobserve(l.target))})},{root:null,rootMargin:"0px",threshold:1}).observe(i)}const M=new MutationObserver((z,d)=>{const i=document.getElementById("nuclen-quiz-container"),u=document.getElementById("nuclen-summary-container");i&&u&&(L("#nuclen-summary-container","nuclen_summary_view"),L("#nuclen-quiz-container","nuclen_quiz_view"),d.disconnect())});M.observe(document.body,{childList:!0,subtree:!0});window.NuclenLazyLoadComponent("nuclen-quiz-container","nuclearEngagementInitQuiz");function T(){var I,E;const z=parseInt((I=window.NuclenSettings)==null?void 0:I.questions_per_quiz,10)||10,d=parseInt((E=window.NuclenSettings)==null?void 0:E.answers_per_question,10)||4,i=postQuizData.slice(0,z).map(e=>({...e,answers:e.answers.slice(0,d)}));let u=0,g=0;const p=[],l=document.getElementById("nuclen-quiz-container");if(!l)return;const q=document.getElementById("nuclen-quiz-question-container"),a=document.getElementById("nuclen-quiz-answers-container"),b=document.getElementById("nuclen-quiz-progress-bar"),h=document.getElementById("nuclen-quiz-final-result-container"),c=document.getElementById("nuclen-quiz-next-button"),m=document.getElementById("nuclen-quiz-explanation-container");m&&(m.innerHTML=""),c==null||c.addEventListener("click",Q);function Q(){u++,u<i.length?y():k(),l==null||l.scrollIntoView()}function N(){if(!b)return;const e=(u+1)/i.length*100;b.style.width=`${e}%`}function k(){var f;q&&(q.innerHTML=""),a&&(a.innerHTML=""),m&&(m.innerHTML=""),c==null||c.classList.add("nuclen-quiz-hidden");let e=`
    ...
    `,s="";if(g===i.length?s="Perfect!":g>i.length/2?s="Well done!":s="Why not retake the test?",e+=`<div id="nuclen-quiz-score-comment">${s}</div>`,e+='<div id="nuclen-quiz-result-tabs-container">',i.forEach((o,n)=>{e+=`
        <button 
    ...
    `;if(f===0)n+=`
      ...
      `);const s=e.answers.map((o,n)=>({answer:o,originalIndex:n}));s.sort(()=>Math.random()-.5),a&&(a.innerHTML=s.map(({answer:o,originalIndex:n})=>`
        ...
        `).join(""));const f=s.findIndex(o=>o.originalIndex===0);c==null||c.classList.add("nuclen-quiz-hidden"),m&&(m.innerHTML=""),N(),a==null||a.addEventListener("click",function o(n){const t=n.target;if(t.matches("button.nuclen-quiz-answer-button")){const r=parseInt(t.getAttribute("data-original-index")||"0",10),v=s.findIndex(w=>w.originalIndex===r);setTimeout(()=>{$(r,v,f)},100),a.removeEventListener("click",o)}})}y()}window.nuclearEngagementInitQuiz=T;
