...
<div class="nuclen-form-group nuclen-row">
	...
	<div class="nuclen-column nuclen-input-col">
		<label class="nuclen-switch">
			<input type="checkbox" name="nuclen_toc_show_content" id="nuclen_toc_show_content" value="1" <?php checked( empty( $settings['toc_show_toggle'] ) || ! empty( $settings['toc_show_content'] ) ); ?><?php echo empty( $settings['toc_show_toggle'] ) ? esc_attr( ' disabled' ) : ''; ?>>
			<span class="nuclen-slider round"></span>
		</label>
		<p class="description">
