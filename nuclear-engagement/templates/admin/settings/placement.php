...
<div id="placement" class="nuclen-tab-content nuclen-section" style="display:block;">
		...
		<p>
				...
				<span nuclen-tooltip="<?php esc_attr_e( 'Shortcodes and blocks are the most versatile method. If your theme or page-builder lacks suitable slots you can append sections automatically.', 'nuclear-engagement' ); ?>">🛈</span>
		</p>
