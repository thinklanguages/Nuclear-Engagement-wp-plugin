...
<div class="nuclen-summary-format-fields">
	...
	<?php endif; ?>
	<select name="<?php echo esc_attr( $field_prefix ); ?><?php echo $use_array_notation ? '[format]' : 'format'; ?>" id="<?php echo esc_attr( $field_prefix ); ?>format" class="nuclen-input nuclen-summary-format-select">
	...
	<div class="nuclen-summary-paragraph-options" <?php echo ( $summary_format !== 'paragraph' ) ? 'style="display:none;"' : ''; ?>>
		...
		<?php endif; ?>
		<select name="<?php echo esc_attr( $field_prefix ); ?><?php echo $use_array_notation ? '[length]' : 'length'; ?>" id="<?php echo esc_attr( $field_prefix ); ?>length" class="nuclen-input">
	...
	<div class="nuclen-summary-bullet-options" <?php echo ( $summary_format !== 'bullet_list' ) ? 'style="display:none;"' : ''; ?>>
		...
		<?php endif; ?>
		<select name="<?php echo esc_attr( $field_prefix ); ?><?php echo $use_array_notation ? '[number_of_items]' : 'number_of_items'; ?>" id="<?php echo esc_attr( $field_prefix ); ?>number_of_items" class="nuclen-input">
