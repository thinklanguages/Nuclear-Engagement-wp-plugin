<?php
/**
 * SettingsCollectTrait.php - Part of the Nuclear Engagement plugin.
 *
...
trait SettingsCollectTrait {
	...
	private function collect_flags_and_generation(): array {
			$data = array(
				...
				'auto_summary_format'                   => isset( $_POST['auto_summary_format'] ) ? sanitize_text_field( wp_unslash( $_POST['auto_summary_format'] ) ) : 'paragraph',
				'auto_summary_length'                   => isset( $_POST['auto_summary_length'] ) ? intval( wp_unslash( $_POST['auto_summary_length'] ) ) : 30,
				'auto_summary_number_of_items'          => isset( $_POST['auto_summary_number_of_items'] ) ? intval( wp_unslash( $_POST['auto_summary_number_of_items'] ) ) : 5,
