<?php
/**
 * ThemeValidator.php - Part of the Nuclear Engagement plugin.
 *
...
class ThemeValidator {
	...
	private const VALID_COMPONENT_KEYS = array(
		'quiz_container',
		'quiz_button',
		'progress_bar',
		'summary_container',
	...
	private const COMPONENT_SCHEMAS = array(
	...
	private function is_valid_font_weight( $value ): bool {
		$valid_weights = array( 'normal', 'bold', 'bolder', 'lighter', '100', '200', '300', '400', '500', '600', '700', '800', '900' );
