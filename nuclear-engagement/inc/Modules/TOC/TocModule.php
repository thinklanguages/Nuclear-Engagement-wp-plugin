<?php
/**
 * TocModule.php - Part of the Nuclear Engagement plugin.
 *
 * @package NuclearEngagement_Modules_TOC
 */
...
final class TocModule extends AbstractModule {
	...
	protected function registerHooks(): void {
		// Register shortcode.
		add_shortcode( 'nuclen_toc', array( $this, 'renderShortcode' ) );

		// Auto-insert TOC if enabled.
		if ( $this->getConfigValue( 'auto_insert', true ) ) {
			add_filter( 'the_content', array( $this, 'autoInsertToc' ), 20 );
		}
