...
class ResponseUtils {
	public static function json_success( array $data = [], string $message = '' ): void {
	...
	public static function json_error( string $message, array $data = [], int $status_code = 400 ): void {
