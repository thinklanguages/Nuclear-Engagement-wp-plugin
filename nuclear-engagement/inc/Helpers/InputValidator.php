...
class InputValidator {
	 ...
	 */
	public static function validate_text( string $value, string $field, array $rules = [] ) {
		...
		if ( isset( $rules['alphanumeric'] ) && $rules['alphanumeric'] && ! ctype_alnum( str_replace( [ '-', '_', ' ' ], '', $value ) ) ) {
	 ...
	 */
	public static function validate_url( string $value, string $field, array $rules = [] ) {
		self::clear_field_errors( $field );
	 ...
	 */
	public static function validate_integer( $value, string $field, array $rules = [] ) {
		self::clear_field_errors( $field );
	 ...
	 */
	public static function validate_array( $value, string $field, array $rules = [] ) {
		self::clear_field_errors( $field );
