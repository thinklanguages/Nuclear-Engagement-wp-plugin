...
class ServiceRegistry {
	...
	public static function initCoreServices(): void {
		...
		// Error Manager
		$registry->register( 'error_manager', function() {
			return UnifiedErrorManager::getInstance();
		});
		
		// Settings Repository
		$registry->register( 'settings', function() {
		...
		// Post Repository
		$registry->register( 'post_repository', function() use ( $registry ) {
			return new \NuclearEngagement\Repositories\PostRepository();
		});
		
		// Content Storage Service
		$registry->register( 'content_storage', function() use ( $registry ) {
