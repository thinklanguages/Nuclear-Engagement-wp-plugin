...
$extractor = new \NuclearEngagement\Modules\TOC\HeadingExtractor();
$extractor->extract( $wp_posts[1]->post_content, [2, 3] );
...
\NuclearEngagement\Modules\TOC\TocCache::clear_for_post( 1 );
